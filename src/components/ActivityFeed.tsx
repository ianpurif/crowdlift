  ...
  return (
    <div className="apple-card p-6 sm:p-8 animate-fade-in-up">
      ...
      <div className="mt-6 space-y-3">
        ...
        {!isLoading && events.length === 0 && (
          <div className="py-12 text-center rounded-2xl border border-dashed border-[#E2E8F0] bg-[#F8FAFC] px-4">
        ...
        {events.map((event) => (
          <div
            key={event.id}
            className="flex items-center justify-between p-4 rounded-2xl bg-[#F8FAFC] border border-[#E2E8F0] transition-all hover:border-[#2563EB]/30 animate-fade-in-up"
          >
            <div className="flex items-center gap-3 min-w-0">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#2563EB]/10 text-[#2563EB] font-bold">
                <User size={18} />
              </div>
